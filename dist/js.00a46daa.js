...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"components/storage.js":[function(require,module,exports) {
// inport
"use strict";
...
function () {
  function HandleStorage() {
    _classCallCheck(this, HandleStorage);
  }

  _createClass(HandleStorage, [{
    key: "handleSaveData",
    // data in local storage
    value: function handleSaveData(keyName, object) {
      localStorage.setItem(keyName, object);
    } // retrive data from local storage

  }, {
    key: "handleRetriveData",
    value: function handleRetriveData(keyName) {
      return JSON.parse(localStorage.getItem(keyName));
    } // detele data from the local storage

  }, {
    key: "handleDeleteData",
    value: function handleDeleteData(keyName) {
...
var _default = HandleStorage;
exports.default = _default;
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js"}],"components/getElementLocation.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function () {
  function ElmentLocation() {
    _classCallCheck(this, ElmentLocation);
  }

  _createClass(ElmentLocation, [{
...
var _default = ElmentLocation;
exports.default = _default;
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js"}],"components/classRemover.js":[function(require,module,exports) {
"use strict";
...
function () {
  function ClassRemover() {
    _classCallCheck(this, ClassRemover);
  }

  _createClass(ClassRemover, [{
    key: "handleRemoveClass",
    value: function handleRemoveClass(element, className) {
      if (element.length > 1) {
    ...
    key: "handleAddClass",
    value: function handleAddClass(element, className) {
      element.classList.add(className);
    }
  }, {
    key: "setInnerHtml",
    value: function setInnerHtml(element, textContent) {
      var elementLength = element.length;

      if (elementLength > 1) {
        element.forEach(function (ele) {
          return ele.innerHTML = textContent;
        });
      } else {
    ...
    key: "classToggler",
    value: function classToggler(element, className) {
    ...
    key: "handleActiveElement",
    value: function handleActiveElement(nodeList, classToAdd, elementIdentifier) {
...
var _default = ClassRemover;
exports.default = _default;
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js"}],"components/globalSelect.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.cannotShowTheVenue = exports.singleVenueMap = exports.singleVenueDetailsContainer = exports.closeTimonialButton = exports.hideTestimonialContaienr = exports.testimonyContainer = exports.showTestimonials = exports.singleVenueIdKeyName = exports.loadedVenuesStatus = exports.resultMainContainer = exports.favoritePlacesContainer = exports.visitedCitiesKeyname = exports.mapContainer = exports.placesYouLikeWrapper = exports.deleteTrashContainer = exports.visitedCitiesErrorMessage = exports.deleteConfirmation = exports.visitedCitiesCounter = exports.visitedCitiesContainer = exports.visitedCitiesFilters = exports.visitedCitiesTitile = exports.favoriteFilter = exports.favoriteVenuesErrorMessage = exports.favoriteVenuesLoader = exports.favoriteVenueCounter = exports.placesYouLikeContainer = exports.favoriteCounters = exports.categoryInput = exports.currentFilterDetailsFixedForm = exports.placesYouLike = exports.cityResultContainer = exports.fixForm = exports.searchResultTitle = exports.$map = exports.categoryDetailsIcon = exports.resultContainer = exports.userFilterOptionKeyname = exports.refineMessageButton = exports.alertMessageClass = exports.mainMessageToTheUser = exports.disableHtmlElement = exports.mapLoader = exports.blockResultsLoader = exports.loaderSearchResultDetailsBlock = exports.searchButonLoader = exports.searchResultLocation = exports.searchResultCategory = exports.searchResultCounter = exports.headerHero = exports.versionningDate = exports.cors_api_url = exports.submitButtons = exports.mainContainer = exports.limitInput = exports.dropdownContainer = exports.locationInput = exports.dropdown = exports.inputs = exports.categoryFilter = exports.switchButtonAll = exports.regex = void 0;
// GLOBAL SELECT
var switchButtonAll = document.querySelectorAll(".toggle_container");
exports.switchButtonAll = switchButtonAll;
var categoryFilter = document.querySelectorAll(".form_filter");
exports.categoryFilter = categoryFilter;
var inputs = document.querySelectorAll("input");
exports.inputs = inputs;
var categoryInput = document.querySelector("input#category");
exports.categoryInput = categoryInput;
var locationInput = document.querySelectorAll("#location");
exports.locationInput = locationInput;
var dropdownContainer = document.querySelectorAll(".menu_container");
exports.dropdownContainer = dropdownContainer;
var limitInput = document.querySelectorAll("#limit");
exports.limitInput = limitInput;
var mainContainer = document.querySelector("main");
exports.mainContainer = mainContainer;
var submitButtons = document.querySelectorAll(".submit_button");
exports.submitButtons = submitButtons;
var headerHero = document.querySelector(".header_hero");
exports.headerHero = headerHero;
var categoryDetailsIcon = document.querySelectorAll(".category_details_icon");
exports.categoryDetailsIcon = categoryDetailsIcon;
var $map = document.querySelector("#map");
exports.$map = $map;
var resultContainer = document.querySelector(".search_result_block_content");
exports.resultContainer = resultContainer;
var searchResultTitle = document.querySelector(".search_result_main_title");
exports.searchResultTitle = searchResultTitle;
var placesYouLike = document.querySelector(".places_you_like_main_title");
exports.placesYouLike = placesYouLike;
var visitedCitiesFilters = document.querySelectorAll(".visited_cities_filter");
exports.visitedCitiesFilters = visitedCitiesFilters;
var placesYouLikeWrapper = document.querySelector(".places_you_like_wrapper");
exports.placesYouLikeWrapper = placesYouLikeWrapper;
var deleteConfirmation = document.querySelector(".delete_confirmation");
exports.deleteConfirmation = deleteConfirmation;
var deleteTrashContainer = document.querySelector(".delete_trash_container"); // get the slider parent element

exports.deleteTrashContainer = deleteTrashContainer;
var visitedCitiesCounter = document.querySelector(".visited_cities_counter");
exports.visitedCitiesCounter = visitedCitiesCounter;
var visitedCitiesContainer = document.querySelector(".glide_visted_location");
exports.visitedCitiesContainer = visitedCitiesContainer;
var visitedCitiesTitile = document.querySelector(".visited_location_main_title");
exports.visitedCitiesTitile = visitedCitiesTitile;
var placesYouLikeContainer = document.querySelector(".glide_places_you_liked");
exports.placesYouLikeContainer = placesYouLikeContainer;
var favoriteFilter = document.querySelectorAll(".favorite_filter");
exports.favoriteFilter = favoriteFilter;
var favoriteVenueCounter = document.querySelector(".fovorite_venue_counter");
exports.favoriteVenueCounter = favoriteVenueCounter;
var fixForm = document.querySelector(".fix_search_form");
exports.fixForm = fixForm;
var dropdown = document.querySelectorAll(".menu_container");
exports.dropdown = dropdown;
var favoriteCounters = document.querySelectorAll(".favorite_counter_container");
exports.favoriteCounters = favoriteCounters;
var currentFilterDetailsFixedForm = document.querySelector(".current_filter_details_fixed_form");
exports.currentFilterDetailsFixedForm = currentFilterDetailsFixedForm;
var mapContainer = document.querySelector(".map_container");
exports.mapContainer = mapContainer;
var favoritePlacesContainer = document.querySelector(".places_you_like_container"); // get cities container

exports.favoritePlacesContainer = favoritePlacesContainer;
var cityResultContainer = document.querySelectorAll(".location");
exports.cityResultContainer = cityResultContainer;
var resultMainContainer = document.querySelector(".search_result_container");
exports.resultMainContainer = resultMainContainer;
var searchResultCounter = document.querySelectorAll(".search_result_counter_text");
exports.searchResultCounter = searchResultCounter;
var searchResultCategory = document.querySelectorAll(".search_result_category_text");
exports.searchResultCategory = searchResultCategory;
var searchResultLocation = document.querySelectorAll(".search_result_location_text");
exports.searchResultLocation = searchResultLocation;
var mainMessageToTheUser = document.querySelector(".main_message_to_the_user");
exports.mainMessageToTheUser = mainMessageToTheUser;
var refineMessageButton = document.querySelector(".refine_message");
exports.refineMessageButton = refineMessageButton;
var cannotShowTheVenue = document.querySelector(".cannot_show_the_venue"); // SINGLE VIEW SELECTOR

exports.cannotShowTheVenue = cannotShowTheVenue;
var showTestimonials = document.querySelector(".testimony__button"),
    ...
    singleVenueMap = document.querySelector("#single_map"); // END GLOBAL SELECT
// GLOBAL VARIABLE
// check to see if the user input only digit values

exports.singleVenueMap = singleVenueMap;
exports.singleVenueDetailsContainer = singleVenueDetailsContainer;
exports.closeTimonialButton = closeTimonialButton;
exports.testimonyContainer = testimonyContainer;
exports.showTestimonials = showTestimonials;
var regex = /\D+/gi; // this url allow the app tho retrieve data from apis that do not have a CROSS ORIGIN SHARING value in the response header

exports.regex = regex;
var cors_api_url = "https://cors-anywhere.herokuapp.com/"; // set the foursquare versionning date

exports.cors_api_url = cors_api_url;
var versionningDate = "20181231"; // this variable disable any HTML element

exports.versionningDate = versionningDate;
var disableHtmlElement = "disableElement"; // this class hide the alert message to the user

exports.disableHtmlElement = disableHtmlElement;
var alertMessageClass = "main_message_to_the_user_not_visible"; // keyName for the user filtered options from the search form
// this will help us save and retrieve data from the local storage

exports.alertMessageClass = alertMessageClass;
var userFilterOptionKeyname = "userFilterOption"; // loaded status keyname

exports.userFilterOptionKeyname = userFilterOptionKeyname;
var loadedVenuesStatus = "loadedVenuesStatus"; //set loader variables

exports.loadedVenuesStatus = loadedVenuesStatus;
var searchButonLoader = "\n    <div class=\"lds-ellipsis_button\">\n        <div></div>\n        <div></div>\n        <div></div>\n        <div></div>\n    </div>\n";
exports.searchButonLoader = searchButonLoader;
var loaderSearchResultDetailsBlock = "\n    <div class=\"lds-ellipsis\">\n        <div></div>\n        <div></div>\n        <div></div>\n        <div></div>\n    </div>\n";
exports.loaderSearchResultDetailsBlock = loaderSearchResultDetailsBlock;
var blockResultsLoader = "\n    <p class=\"push_loader_text\">Loading ... please wait</p>\n    <div class=\"loader_on_search\">\n        <div class=\"lds-dual-ring\"></div>\n    </div>\n";
exports.blockResultsLoader = blockResultsLoader;
var mapLoader = "\n        Loading the map ...\n        <div class=\"loader_on_search\">\n            <div class=\"lds-dual-ring\"></div>\n        </div>\n";
exports.mapLoader = mapLoader;
var favoriteVenuesLoader = "\n        <div class=\"loader_places_\">\n            <div class=\"loader_on_search\">\n                <div class=\"lds-dual-ring\"></div>\n            </div>\n        </div>\n";
exports.favoriteVenuesLoader = favoriteVenuesLoader;
var favoriteVenuesErrorMessage = "\n        <div class=\"loader_places_\">\n            <p class=\"fovorite_error_main\">Your favorite list is empty.</p>\n            <p class=\"fovorite_error_sub\">All favorite places will appear here</p>\n        </div>\n";
exports.favoriteVenuesErrorMessage = favoriteVenuesErrorMessage;
var visitedCitiesErrorMessage = "\n        <div class=\"loader_places_\">\n            <p class=\"fovorite_error_main\">Your Cities list is empty.</p>\n            <p class=\"fovorite_error_sub\">All visited cities will appear here. Please give a try</p>\n        </div>\n";
exports.visitedCitiesErrorMessage = visitedCitiesErrorMessage;
var visitedCitiesKeyname = "visitedCitiesEplaces"; // single view variables

exports.visitedCitiesKeyname = visitedCitiesKeyname;
var hideTestimonialContaienr = "testimonials_container_hide"; // keyname when save a single venue id in the local storage

exports.hideTestimonialContaienr = hideTestimonialContaienr;
var singleVenueIdKeyName = "singleVenueId"; // GLOBAL VARIABLE

exports.singleVenueIdKeyName = singleVenueIdKeyName;
},{}],"components/validator.js":[function(require,module,exports) {
"use strict";
...
var _storage = _interopRequireDefault(require("../components/storage"));

var _globalSelect = require("../components/globalSelect");
...
// instantiate objects
var HandleStore = new _storage.default(); // validator class
...
function () {
  ...
  _createClass(Validator, [{
    key: "isLatLongEmpty",
    value: function isLatLongEmpty(value, target) {
      var newCoordinate = HandleStore.handleRetriveData("currentLocation");
    ...
    key: "mathOperations",
    value: function mathOperations(value, number, operator) {
      switch (operator) {
        case "add":
          return value + number;
          break;
    ...
    value: function roundToPrecision(value, precision) {
      var multiplier = Math.pow(10, precision || 0);
      return Math.round(value * multiplier) / multiplier;
    }
  }, {
    key: "isFalsy",
    value: function isFalsy(element, target) {
      if (target === "category") {
    ...
    key: "isPlural",
    value: function isPlural(number, str) {
      return number > 1 ? str + "s" : str;
    }
  }, {
    key: "isInTheViewPort",
    value: function isInTheViewPort(element) {
      var elementLocation = element.getBoundingClientRect();
      return elementLocation.top >= 0 && elementLocation.left >= 0 && elementLocation.right <= (window.innerWidth || document.documentElement.innerWidth) && elementLocation.bottom <= (window.innerHeight || document.documentElement.innerHeight);
    }
  }, {
    key: "isFavoriteGreatThanNine",
    value: function isFavoriteGreatThanNine(number) {
      return number > 9 ? "9+" : number;
    }
  }, {
    key: "isInFavoriteList",
    value: function isInFavoriteList(id) {
      var favoriteVenuesFromLocalStodrage = HandleStore.handleRetriveData("storedFavoriteVenuesId") || [];

      if (favoriteVenuesFromLocalStodrage) {
        for (var e = 0; e < favoriteVenuesFromLocalStodrage.length; e++) {
    ...
    key: "extractFirstNumber",
    value: function extractFirstNumber(number) {
    ...
    key: "isAtACertainPercentOfTheViewport",
    value: function isAtACertainPercentOfTheViewport(elementDistanceFromTheButton) {
      return Math.floor(elementDistanceFromTheButton / window.innerHeight * 100);
    }
  }, {
    key: "isThisValueInThatArrayObject",
    value: function isThisValueInThatArrayObject(valueToFind, object, keyToSeachFromTheArrayObject) {
      if (object.length > 0) {
        return object.some(function (item) {
          return item[keyToSeachFromTheArrayObject] === valueToFind;
        });
      } else return false;
    }
  }, {
    ...
    key: "handllRedirection",
    value: function handllRedirection(e) {
      // get the clicked element
      var clickedElement = e.target; // get its id

      var clickedElementId = clickedElement.getAttribute("id"); // save it to use on the single view page

      HandleStore.handleSaveData(_globalSelect.singleVenueIdKeyName, JSON.stringify({
        id: clickedElementId
      })); // redirect the user on the single view page
      //window.location.href = "http://localhost:1234/singleview.html";

      _globalSelect.cannotShowTheVenue.classList.remove("cannot_show_the_venue_hide");

      setTimeout(function () {
        _globalSelect.cannotShowTheVenue.classList.add("cannot_show_the_venue_hide");
      }, 5000);
    }
  }]);
...
exports.default = _default;
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","../components/storage":"components/storage.js","../components/globalSelect":"components/globalSelect.js"}],"node_modules/@glidejs/glide/dist/glide.esm.js":[function(require,module,exports) {
...
exports.default = _default;
},{}],"components/handleVenuesLike.js":[function(require,module,exports) {
"use strict";
...
var _classRemover = _interopRequireDefault(require("../components/classRemover"));
...
var handleStore = new _storage.default();
var handleRemove = new _classRemover.default();
var handleValidate = new _validator.default();

var venuesLike =
/*#__PURE__*/
function () {
  function venuesLike() {
    _classCallCheck(this, venuesLike);
  }

  _createClass(venuesLike, [{
    key: "handleLikes",
    value: function handleLikes() {
      var _this = this;

      // active the ALL filter button
      handleRemove.handleActiveElement(_globalSelect.favoriteFilter, "filter_Active", "filter_all_container"); // delete the load status from the locale storage
      // this action allow the favorite venues to be loaded with new content each time a user likes a venue

      handleStore.handleDeleteData("loadFavoriteStatus"); // animate the favorite icon

      handleRemove.handleAddClass(this, "animate_like"); // animate the counter container (small circle red - top right corner)

      _globalSelect.favoriteCounters.forEach(function (counter) {
        return handleRemove.handleAddClass(counter, "animate_red_circle");
      }); // remove the animate on favorite icon after 1 minute


      setTimeout(function () {
        handleRemove.handleRemoveClass(_this, "animate_like");

        _globalSelect.favoriteCounters.forEach(function (counter) {
          return handleRemove.handleRemoveClass(counter, "animate_red_circle");
        });
      }, 1000); // get the id of the venue that has been clicked

      var venueId = this.parentNode.parentNode.parentNode.getAttribute("id"); // get the venue categorey

      var venueCategory = this.parentNode.parentNode.parentNode.dataset.category; // get the currrent venues list from the local storage

      var currentVenues = handleStore.handleRetriveData("currentVenues"); // current venue that is being set as favorite

      var currerntVenueFavorite = currentVenues.filter(function (venue) {
      ...
      var venueStatus = this.dataset.status; // initialize the an empty array to old the first liked venue

      var favoriteVenueIds = []; // call all favorite venues venue from the local storage

      var favoriteVenuesFromLocalStorage = handleStore.handleRetriveData("storedFavoriteVenuesId");
      ...
      if (!venueStatus) {
        ...
        if (favoriteVenuesFromLocalStorage) {
          ...
          if (!favoriteVenuesFromLocalStorage.some(function (favorite) {
            return favorite.venue === venueIdentity.venue && favorite.category === venueIdentity.category;
          })) {
            // add the current venue that is being set as favorite to the array list of venues
            favoriteVenuesFromLocalStorage.push(venueIdentity); // save the venues list with the new venue added

            handleStore.handleSaveData("storedFavoriteVenuesId", JSON.stringify(favoriteVenuesFromLocalStorage));
          }
        } else {
          // if we do not have any data from the local storage
          // push the new venue id to the empty array initialized above and
          favoriteVenueIds.push(venueIdentity); // save it in the local storage as the fist entry.

          handleStore.handleSaveData("storedFavoriteVenuesId", JSON.stringify(favoriteVenueIds));
        } // set the venue staus to liked


        this.dataset.status = "liked"; // set the heart to a full heart

        this.setAttribute("src", "full_favorite.910f9482.svg");
      } else {
        // run this code if the user unlike a venue
        if (favoriteVenuesFromLocalStorage || favoriteVenuesFromLocalStorage.includes(venueIdentity)) {
          // set the venue status to nothing (this means the venue has not ye been liked by the user)
          this.dataset.status = ""; // set the heart to an empty one

          this.setAttribute("src", "favorite_home.eef3b794.svg"); // filter the Venue Ids from the local storage and remove the one that correspond to the one that the user unliked

          var newFilteredVenueId = favoriteVenuesFromLocalStorage.filter(function (favorite) {
            return favorite.venue.id !== venueIdentity.venue.id;
          }); // save the new venue Ids list in the local storage

          handleStore.handleSaveData("storedFavoriteVenuesId", JSON.stringify(newFilteredVenueId));
        }
      }

      var favoriteNumber = handleValidate.isFavoriteGreatThanNine(handleCount.handleCountLikes("storedFavoriteVenuesId"));
      handleRemove.setInnerHtml(_globalSelect.favoriteCounters, favoriteNumber);
    } // this method return the total number of liked venues

  }, {
    key: "handleCountLikes",
    value: function handleCountLikes(keyName) {
...
var _default = venuesLike;
exports.default = _default;
var handleCount = new venuesLike();
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","../components/storage":"components/storage.js","../components/classRemover":"components/classRemover.js","../components/validator":"components/validator.js","../components/globalSelect":"components/globalSelect.js"}],"components/deleteFavorite.js":[function(require,module,exports) {
"use strict";
...
var _handleVenuesLike = _interopRequireDefault(require("../components/handleVenuesLike"));

var _classRemover = _interopRequireDefault(require("../components/classRemover"));

var _getFavorite = require("../components/getFavorite");
...
var handleValidate = new _validator.default();
var handleRemove = new _classRemover.default();
var handleCount = new _handleVenuesLike.default();

var DeleteFavorite =
/*#__PURE__*/
function () {
  function DeleteFavorite() {
    _classCallCheck(this, DeleteFavorite);
  }

  _createClass(DeleteFavorite, [{
    key: "handleDelete",
    //**
    ...
    value: function handleDelete(element) {
      ...
      if (element.length > 1) {
        element.forEach(function (ele) {
          return ele.addEventListener("click", deleteElement);
        });
        tab = "all";
      } else {
      ...
      function deleteElement(e) {
        // get the clicked element
        var clickedElement = e.target; // check to see if the current clicked element is the heart icon

        if (clickedElement.classList.contains("favorite_icon")) {
          /// get the parent element (3 level up)
          var clickedElementParentNode = clickedElement.parentNode.parentNode.parentNode; // if yes remove the parent node element from the view

          handleDeleteEvents.handleDelteAnimation(null, clickedElementParentNode); // set target (all, fun, coffee)
          // doing this help refech only the from where the user delete a place (venue);

          var target = tab || clickedElementParentNode.dataset.category; // get the favorite venues from the local storage

          var favoriteVenuesFromLocalStorage = handleStore.handleRetriveData("storedFavoriteVenuesId"); // filter the Venue Ids from the local storage and remove the one that correspond to the one that the user unliked

          var newFilteredVenueId = favoriteVenuesFromLocalStorage.filter(function (favorite) {
            return favorite.venue.id !== clickedElementParentNode.getAttribute("id");
          }); // save the new venue Ids list in the local storage

          handleStore.handleSaveData("storedFavoriteVenuesId", JSON.stringify(newFilteredVenueId)); // wait 2ms

          setTimeout(function () {
            //refresh the the venue list in the UI
            // note that we keep the actual tab active and only its venues list is refresh
            if (newFilteredVenueId.length === 3 || newFilteredVenueId.length === 0) {
              _getFavorite.handleDisplayVenue.handleFavorite(target, "form");
            } // check to see if the user is currently deleting from others tab than the All tab


            var currentActiveTab = _globalSelect.placesYouLikeWrapper.querySelector(".filter_Active").dataset.favoritecategory; // if the current tab is different to all tab category


            if (currentActiveTab !== "all") {
              // check to see if there still any favorite for the current tab
              var isStillInFavoriteArray = handleValidate.isThisValueInThatArrayObject(currentActiveTab, newFilteredVenueId, "category"); // if false,
              // reload and display the empty status message to the user

              if (!isStillInFavoriteArray) {
                _getFavorite.handleDisplayVenue.handleFavorite(currentActiveTab, "form");
              }
            }
          }, 1500); // reset the favorite counter in the nav bar to the current favorite length

          var favoriteNumber = handleValidate.isFavoriteGreatThanNine(handleCount.handleCountLikes("storedFavoriteVenuesId")); //display the new counter value

          handleRemove.setInnerHtml(_globalSelect.favoriteCounters, favoriteNumber); // reset the favorite button counter

          handleRemove.setInnerHtml(_globalSelect.favoriteVenueCounter, favoriteNumber + " " + handleValidate.isPlural(favoriteNumber, "Result")); // add the delete text to the delete message container

          handleRemove.setInnerHtml(_globalSelect.deleteConfirmation, "<p>Favorite Deleteted</p>"); // show the delete confirmation to the user

          handleRemove.classToggler(_globalSelect.deleteConfirmation, "hide_delete_confirmation"); // wait 1 second to remove the delete confirmation message

          setTimeout(function () {
            handleRemove.classToggler(_globalSelect.deleteConfirmation, "hide_delete_confirmation");
          }, 2000);
        }
      }
    }
  }, {
    key: "handleDelteAnimation",
    value: function handleDelteAnimation() {
      var elementNode = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      var elementToAnimate = arguments.length > 1 ? arguments[1] : undefined;

      // this block animate the trash contaienr when the user over and leave
      if (elementNode) {
        elementNode.forEach(function (icon) {
          return icon.addEventListener("mouseover", function (e) {
            handleRemove.handleRemoveClass(_globalSelect.deleteTrashContainer, "hide_delete_trash_container");
          });
        });
        elementNode.forEach(function (icon) {
          return icon.addEventListener("mouseleave", function (e) {
            handleRemove.handleAddClass(_globalSelect.deleteTrashContainer, "hide_delete_trash_container");
          });
        });
      ...
      if (elementToAnimate) {
        ...
        var deleteTrashContainerLocation = _globalSelect.deleteTrashContainer.getBoundingClientRect(); // move the block venue to the same position as the trash container


        elementToAnimate.style.transform = "translate(".concat(deleteTrashContainerLocation.left, "px, ").concat(deleteTrashContainerLocation.top, "px)"); // await 1 second and remove the element from the UI
...
var _default = DeleteFavorite;
exports.default = _default;
var handleDeleteEvents = new DeleteFavorite();
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","../components/storage":"components/storage.js","../components/validator":"components/validator.js","../components/handleVenuesLike":"components/handleVenuesLike.js","../components/classRemover":"components/classRemover.js","../components/getFavorite":"components/getFavorite.js","../components/globalSelect":"components/globalSelect.js"}],"components/getFavorite.js":[function(require,module,exports) {
"use strict";
"user strict";
...
exports.handleDisplayVenue = void 0;
...
var _deleteFavorite = _interopRequireDefault(require("../components/deleteFavorite"));
...
var handleStore = new _storage.default();
var handleRemove = new _classRemover.default();
var handleCounter = new _handleVenuesLike.default();
var handleValidate = new _validator.default();
var handleDeleteFavorite = new _deleteFavorite.default();

var GetFavoriteVenues =
/*#__PURE__*/
function () {
  function GetFavoriteVenues() {
    _classCallCheck(this, GetFavoriteVenues);
  }

  _createClass(GetFavoriteVenues, [{
    key: "handleFavorite",
    //**
    ...
    /* tells the function which category to fetch from the local storage (eg: food, fun or  coffee )
       /* @param {String} target 
       */
    value: function handleFavorite(target) {
      var from = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var fromsection = arguments.length > 2 ? arguments[2] : undefined;
      ...
      var loadedStatus = handleStore.handleRetriveData("loadFavoriteStatus"); // check to see if the loaded status is available and the status is not set to false
      ...
      if ((!loadedStatus || !loadedStatus.status) && target === "all") {
        // active the ALL filter button
        handleRemove.handleActiveElement(_globalSelect.favoriteFilter, "filter_Active", "fav_filter_all_container"); // show the loader to the user

        handleRemove.setInnerHtml(_globalSelect.placesYouLikeContainer, _globalSelect.favoriteVenuesLoader); // get the venues from the local storage

        var getFavoriteVenuresFromLocalStorage = handleStore.handleRetriveData("storedFavoriteVenuesId"); // check to see if have 1 or more venues

        if (!getFavoriteVenuresFromLocalStorage) {
          handleRemove.setInnerHtml(_globalSelect.placesYouLikeContainer, _globalSelect.favoriteVenuesErrorMessage); // set the total of favorite venues to 0 result

          handleRemove.setInnerHtml(_globalSelect.favoriteVenueCounter, "0 Result");
          return;
        }

        if (getFavoriteVenuresFromLocalStorage) {
          if (handleCounter.handleCountLikes(getFavoriteVenuresFromLocalStorage) < 1) {
            handleRemove.setInnerHtml(_globalSelect.placesYouLikeContainer, _globalSelect.favoriteVenuesErrorMessage); // set the total of favorite venues to 0 result
            ...
            setTimeout(function () {
              ...
              handleDisplayVenue.handleFavoriteUI(getFavoriteVenuresFromLocalStorage);
            }, 2000); // set the load status to true to prevent multiple loadings

            handleStore.handleSaveData("loadFavoriteStatus", JSON.stringify({
              status: true
            }));
          }
        }
      ...
      if (from === "form") {
        ...
        var _getFavoriteVenuresFromLocalStorage = handleStore.handleRetriveData("storedFavoriteVenuesId"); // check to see if we have 1 or more venues
        // if no venues stop the function execution


        if (!_getFavoriteVenuresFromLocalStorage) {
          handleRemove.setInnerHtml(_globalSelect.placesYouLikeContainer, _globalSelect.favoriteVenuesErrorMessage); // set the total of favorite venues to 0 result
        ...
        if (_getFavoriteVenuresFromLocalStorage) {
          ...
          if (handleCounter.handleCountLikes(_getFavoriteVenuresFromLocalStorage) < 1) {
            ...
            var filteredFavoriteVenues = null; // check to see what button was clicked by the user
            ...
            if (target !== "all") {
              filteredFavoriteVenues = _getFavoriteVenuresFromLocalStorage.filter(function (venue) {
              ...
              filteredFavoriteVenues = _getFavoriteVenuresFromLocalStorage;
            ...
            if (handleCounter.handleCountLikes(filteredFavoriteVenues) < 1) {
              ...
              handleRemove.setInnerHtml(_globalSelect.placesYouLikeContainer, _globalSelect.favoriteVenuesLoader); // build the error message

              var favoriteVenuesErrorMessageByCategory = "\n                    <div class=\"loader_places_\">\n                        <p class=\"fovorite_error_main\">You havn't a favorite in <b> ".concat(handleValidate.capitalize(target), " </b> category</p>\n                        <p class=\"fovorite_error_sub\">All favorite places will appear here</p>\n                    </div>\n            "); // wait 1 second

              setTimeout(function () {
                // and display the error message to the user
                handleRemove.setInnerHtml(_globalSelect.placesYouLikeContainer, favoriteVenuesErrorMessageByCategory);
                _globalSelect.placesYouLikeContainer.style.minHeight = 150 + "px"; //finally
              ...
              handleRemove.setInnerHtml(_globalSelect.placesYouLikeContainer, _globalSelect.favoriteVenuesLoader); // wait 1 second
    ...
    key: "handleFavoriteUI",
    value: function handleFavoriteUI(object) {
      var favoriteVenues = object.map(function (place) {
        return "\n            <div class=\"glide__slide custome_style_ custome_style_un_carousel\">\n                <div id=\"".concat(place.venue.id, "\" data-category=\"").concat(place.category, "\" \n                class=\"venue_block_container fav_venue_block_container\">\n                    <div class=\"venue_image_container\" style=\"background-image: url('https://source.unsplash.com/featured/?").concat(place.category, "')\">\n                        <div class=\"venue_set_favorite_container\">\n                            <img data-status=\"\" class=\"favorite_icon delete_favorite_icon\" src=\"trash.e2762dec.svg\" alt=\"\">\n                        </div> \n                    </div>\n                \n                    <div class=\"venue_description_name_address\">\n                         <p class=\"venue_description\">").concat(handleValidate.isFalsy(place.venue.categories[0], "category"), "</p>\n                    <p class=\"venue_name\">").concat(handleValidate.isFalsy(place.venue.name), "</p>\n                    <p class=\"venue_address\">").concat(handleValidate.isFalsy(place.venue.location.formattedAddress[0]), " </p>\n                    <p class=\"venue_sub_address\">").concat(handleValidate.isFalsy(place.venue.location.formattedAddress[1]), "</p>\n                    </div>\n                \n                    <div class=\"venue_distance_explore_button\">\n                        <div class=\"venue_distance\">\n                        <img src=\"distance_search.982581db.svg\" alt=\"eplaces\">\n                        <p>").concat(handleValidate.isFalsy(handleValidate.roundToPrecision(handleValidate.mathOperations(place.venue.location.distance, 1000, "div"), 1)), "km</p>\n                    </div>\n                    <div class=\"venue_explore_button\">\n                        <button data-from=\"home\" class=\"explore_button\" id=\"").concat(handleValidate.isFalsy(place.venue.id), "\">Explore</button>\n                    </div>\n                    </div>\n                </div>\n            \n            </div>\n          \n          ");
      }).join(""); // construct the favorite venues carousel

      var favoriteVenuesBlock = "\n            <div class=\"glide__track\" data-glide-el=\"track\">\n                <div class=\"glide__slides\">\n                        ".concat(favoriteVenues, "\n                </div>\n            </div>\n\n        \n            <div class=\"slide_arrow_container glide__arrows\" data-glide-el=\"controls\">\n                <img src=\"arrow_left.35058f2e.svg\" class=\"slide_arrow a_left glide__arrow glide__arrow--left\" data-glide-dir=\"<\">\n                <img src=\"arrow_right.bd98ca69.svg\" class=\"slide_arrow a_right glide__arrow glide__arrow--right\" data-glide-dir=\">\">\n            </div>\n        "); // do not create a carousel if the favorite venues array lenght is less than 4

      if (object.length >= 4) {
        // display the venues carousel to the UI
        handleRemove.setInnerHtml(_globalSelect.placesYouLikeContainer, favoriteVenuesBlock); // select all slider block

        var sliderBlocks = document.querySelectorAll(".custome_style_un_carousel"); // remove all classes that style the venues when the carousel is desable

        sliderBlocks.forEach(function (element) {
          return element.classList.remove("custome_style_");
        }); // initialise the carousel

        new _glide.default(".glide_places_you_liked", {
          type: "carousel",
          startAt: 0,
          perView: 4 //animationDuration: 1500,
          //rewindDuration: 2000
        ...
        setTimeout(function () {
          ...
          handleDeleteFavorite.handleDelete(document.querySelectorAll(".delete_favorite_icon")); // on all explore link
          // this code when the user click "Explore" on the venue block

          document.querySelectorAll(".explore_button").forEach(function (button) {
            return button.addEventListener("click", handleValidate.handllRedirection);
          });
        }, 1000);
      } else {
        // display the venues to the UI
        handleRemove.setInnerHtml(_globalSelect.placesYouLikeContainer, favoriteVenues); // add a listner for the click event on the slider parent element
        // this event will help us determine if the user want to unlike (unfavorite) a place

        handleDeleteFavorite.handleDelete(_globalSelect.placesYouLikeContainer);
      } // get the total of favorite venues


      var totalVenues = handleCounter.handleCountLikes(object);
      handleRemove.setInnerHtml(_globalSelect.favoriteVenueCounter, totalVenues + " " + handleValidate.isPlural(totalVenues, "Result")); // add a listener for the mouse over event on the each trash icon
      ...
      handleDeleteFavorite.handleDelteAnimation(document.querySelectorAll(".delete_favorite_icon"));
    }
  }]);
...
var handleDisplayVenue = new GetFavoriteVenues();
exports.handleDisplayVenue = handleDisplayVenue;
},{"@glidejs/glide":"node_modules/@glidejs/glide/dist/glide.esm.js","babel-polyfill":"node_modules/babel-polyfill/lib/index.js","../components/storage":"components/storage.js","../components/classRemover":"components/classRemover.js","../components/handleVenuesLike":"components/handleVenuesLike.js","../components/validator":"components/validator.js","../components/deleteFavorite":"components/deleteFavorite.js","../components/switch":"components/switch.js","../components/globalSelect":"components/globalSelect.js"}],"components/getCities.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.UI = exports.getCities = void 0;

require("babel-polyfill");

var _getElementLocation = _interopRequireDefault(require("./getElementLocation"));
...
// instantiate the object
var handleRemoveClass = new _classRemover.default();
var handleValidate = new _validator.default(); // fetch cities

var getCities =
/*#__PURE__*/
function () {
  function getCities() {
    _classCallCheck(this, getCities);

    this.searchLoader = "\n        <div class=\"loader_on_search\">\n            <div class=\"lds-dual-ring\"></div>\n        </div>\n        ";
    this.notFoundMessage = "\n    <div class=\"hint_container\">\n      <p class=\"main_hint\">Oops ! city not found.</p>\n      <p class=\"sub_hint\">Please, double check the spelling.</p>\n    </div>";
  }

  _createClass(getCities, [{
    key: "fetchCities",
    value: function () {
      var _fetchCities = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee() {
        var input, apiBaseUrl;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                //cityResultContainer.innerHTML = handleGetCities.searchLoader;
                input = this; // CREDIT : Geobytes API is a private property of GEOBYTES
                // for more info on the api visit  http://gd.geobytes.com/

                apiBaseUrl = "http://gd.geobytes.com/AutoCompleteCity?q=".concat(input.value, "&fulltext=\u201Dtrue\u201D");
                _context.next = 4;
                return fetch(_globalSelect.cors_api_url + apiBaseUrl).then(function (result) {
                  return result.json();
                }).then(function (data) {
                  return handleUI.displayCity(data);
                }).catch(function (e) {
                  console.log(e);
                });
...
function () {
  ...
  _createClass(UI, [{
    key: "displayCity",
    value: function displayCity(citiesObject) {
      _globalSelect.cityResultContainer.forEach(function (container) {
        return container.innerHTML = handleGetCities.searchLoader;
      });

      var cities = citiesObject;
      var city = cities.map(function (city) {
        if (city !== "%s" && city.length > 0) {
          var cityName = handleUI.extractCityCountry(city)[0];
          var countryName = handleUI.extractCityCountry(city)[handleUI.extractCityCountry(city).length - 1];
          var cityInitial = handleUI.extractCityCountry(city)[handleUI.extractCityCountry(city).length - 2];
          return "\n            <li data-target=\"location\" data-value=\"".concat(city, "\">\n                <div class=\"city_name\" data-target=\"location\" data-value=\"").concat(city, "\">\n                    <p data-target=\"location\" data-value=\"").concat(city, "\">").concat(cityName, "</p>\n                </div>\n                <div class=\"country_continent_name\" data-target=\"location\" data-value=\"").concat(city, "\">\n                    <p data-target=\"location\" data-value=\"").concat(city, "\">").concat(cityInitial, " - ").concat(countryName, "</p>\n                </div>\n            </li>\n        ");
        }
      }).join("");
      var timeBeforDisplayingResult = setTimeout(function () {
        if (city && city.length !== 0 && city !== " ") {
          _globalSelect.cityResultContainer.forEach(function (container) {
            return container.innerHTML = city;
          });
        } else {
          _globalSelect.cityResultContainer.forEach(function (container) {
            return container.innerHTML = handleGetCities.notFoundMessage;
          });
        }
    ...
    key: "extractCityCountry",
    value: function extractCityCountry(str) {
      return str ? str.split(",") : "";
    } // fill in the input withe the selected city

  }, {
    key: "fillupTheForom",
    value: function fillupTheForom(e) {
      if (!e.target.dataset.target) return; // get the clicked element id to target the corresponding input

      var targetId = e.target.dataset.target;
      var value = e.target.dataset.value; // set the value of the target input

      var targetInput = document.querySelectorAll("input#".concat(targetId));
      targetInput.forEach(function (input) {
        return input.value = value;
      });
      targetInput.forEach(function (input) {
        return handleRemoveClass.handleRemoveClass(input, "arrow_up");
      });
      targetInput.forEach(function (input) {
        return handleRemoveClass.handleAddClass(input, "arrow_down");
      }); // remove the drop list list in the UI

      document.querySelectorAll(".".concat(targetId)).forEach(function (input) {
        return input.style.display = "none";
      });
    } // handle event on the limit bounding input

  }, {
    key: "handleLimitInput",
    value: function handleLimitInput(e) {
      // get he event type
      var eventType = e.type; //get the target input value

      var iValue = handleValidate.extractFirstNumber(e.target.value) * 1000; //get get the value length

      var valueLength = iValue.length; // get the error container

      var errorMessageContainer = document.querySelector(".errorMessage"); // get the target input location (width, left, top, ...)

      var targetInputWidth = handleLocation.getElementLocation(this); // initialize error message message

      var onlyDigitsMessage = "\n      <p class=\"main_error_title\">Please ! </p>\n      <p class=\"sub_error_title\">Only digits are allowed.</p>\n      <p class=\"sub_error_title\">eg: 222, 400, 10000.</p>\n    ";
      ...
      if (iValue > 100000) {
        ...
        errorMessageContainer.style.marginTop = targetInputWidth.top + targetInputWidth.height + "px";
        errorMessageContainer.style.marginLeft = targetInputWidth.left + "px";
        errorMessageContainer.style.display = "block";
        errorMessageContainer.innerHTML = greatNumber;
        errorMessageContainer.classList.add("errorMessageActive"); //wait 3 second and display
      ...
      var container = document.querySelector(".".concat(e.target.getAttribute("id"))); // hide or show the limit dropdown if the user is typing manually the limit

      if (eventType === "input") {
        valueLength > 1 ? container.style.display = "none" : container.style.display = "block";
      }
    }
  }]);
...
exports.UI = UI;
var handleUI = new UI(); // instntiate the cities objec

var handleGetCities = new getCities(); // instantiate the get element location

var handleLocation = new _getElementLocation.default(); // exporting object for external usage
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","./getElementLocation":"components/getElementLocation.js","../components/classRemover":"components/classRemover.js","../components/validator":"components/validator.js","./globalSelect":"components/globalSelect.js"}],"components/getVisitedCities.js":[function(require,module,exports) {
"use strict";
"user strict";
...
var _getCities = require("../components/getCities");
...
var handleRemove = new _classRemover.default();
var handleValidate = new _validator.default();
var handleExtact = new _getCities.UI();
...
function () {
  ...
  _createClass(GetCities, [{
    key: "handleVisitedCities",
    value: function handleVisitedCities(target) {
      var from = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      // get visited cities from the local storage
      var visitedCities = handleStore.handleRetriveData(_globalSelect.visitedCitiesKeyname) || []; // get the loaded status
      // if it not false load otherwise do no laad any city

      var visitedCitiesLoaded = handleStore.handleRetriveData("visitedCitiesLoaded"); //check if the cities array length is more than 0
      ...
      if (visitedCities.length > 0) {
        ...
        if (target === "all" && !visitedCitiesLoaded) {
          // active the ALL filter button
          handleRemove.handleActiveElement(_globalSelect.visitedCitiesFilters, "filter_Active", "cities_filter_all_container"); // display the loader ot the user

          handleRemove.setInnerHtml(_globalSelect.visitedCitiesContainer, _globalSelect.favoriteVenuesLoader); // send all cities to the UI handler

          handleUI.handleVisitedCitiesUI(visitedCities); // set the counter to the array length

          handleRemove.setInnerHtml(_globalSelect.visitedCitiesCounter, visitedCities.length + " " + handleValidate.isPlural(visitedCities.length, "Result")); // let first log to make sure of what we are is right :)
          //console.log(visitedCities);
          //set the loaded status to true in order to prevent multiple laoding on scroll

          handleStore.handleSaveData("visitedCitiesLoaded", JSON.stringify({
            status: true
          }));
        ...
        if (from === "form") {
          ...
          var filteredVisitedCities = null; // if the event came from the user click and the clicked button was "all"
          // execut this section

          if (target === "all") {
            // display the loader ot the user
            handleRemove.setInnerHtml(_globalSelect.visitedCitiesContainer, _globalSelect.favoriteVenuesLoader);
            filteredVisitedCities = visitedCities; // send all cities to the UI handler

            handleUI.handleVisitedCitiesUI(filteredVisitedCities); // set the counter to the array length

            handleRemove.setInnerHtml(_globalSelect.visitedCitiesCounter, filteredVisitedCities.length + " " + handleValidate.isPlural(filteredVisitedCities.length, "Result"));
          } else {
            // display the loader ot the user
            handleRemove.setInnerHtml(_globalSelect.visitedCitiesContainer, _globalSelect.favoriteVenuesLoader); // if the user has cliked the others category the execute this block
            // filter the cities array

            filteredVisitedCities = visitedCities.filter(function (city) {
              return city.category === target;
            });
            ...
            if (filteredVisitedCities.length > 0) {
              ...
              handleRemove.setInnerHtml(_globalSelect.visitedCitiesCounter, "0 Result"); // build the error message

              var favoriteVenuesErrorMessageByCategory = "\n                    <div class=\"loader_places_\">\n                        <p class=\"fovorite_error_main\">You havn't search for <b> ".concat(handleValidate.capitalize(target), " </b> in any city</p>\n                        <p class=\"fovorite_error_sub\">All cities you previously visited will appear here</p>\n                    </div>\n            "); // await 1 second

              setTimeout(function () {
                // and display the message to the user
                handleRemove.setInnerHtml(_globalSelect.visitedCitiesContainer, favoriteVenuesErrorMessageByCategory);
              }, 1000);
            }
          }
        }
        ...
        //set the counter to zero
        handleRemove.setInnerHtml(_globalSelect.visitedCitiesCounter, "List Empty"); // display the the message to the user

        handleRemove.setInnerHtml(_globalSelect.visitedCitiesContainer, _globalSelect.visitedCitiesErrorMessage);
      }
    } //**
    ...
    key: "handleVisitedCitiesUI",
    value: function handleVisitedCitiesUI(cities) {
      // create a list of all cities
      var citiesList = cities.map(function (city) {
        // extact region initial and country name from the City name
        var cityName = handleExtact.extractCityCountry(city.city)[0];
        var countryName = handleExtact.extractCityCountry(city.city)[handleExtact.extractCityCountry(city.city).length - 1];
        var cityInitial = handleExtact.extractCityCountry(city.city)[handleExtact.extractCityCountry(city.city).length - 2];
        return "\n                <div class=\"glide__slide\">\n                    <!--start city block-->\n                    <div class=\"venue_block_container\">\n                        <div data-city=\"".concat(city.city, "\" data-category=\"").concat(city.category, "\" class=\"venue_image_container venue_image_container_city\" style=\"background-image: url('https://source.unsplash.com/featured/?").concat(cityName, ", ").concat(countryName, "')\">\n                            <div class=\"city_set_favorite_container\">\n                                <p class=\"main_city_name\">").concat(cityName, "</p>\n                                <p class=\"sub_city_country_name\">").concat(cityInitial, " - ").concat(countryName, "</p>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n        ");
      }).join(""); // create the carousel block
      ...
      setTimeout(function () {
        if (cities.length > 5) {
          ...
          handleRemove.setInnerHtml(_globalSelect.visitedCitiesContainer, citiesBlock); // initialize the carousel

          new _glide.default(".glide_visted_location", {
            type: "carousel",
            startAt: 0,
            perView: 5 //animationDuration: 1500,
            //rewindDuration: 2000

          }).mount();
        } else {
          handleRemove.setInnerHtml(_globalSelect.visitedCitiesContainer, citiesList);
        }
      }, 1000); // wait 2s

      setTimeout(function () {
        // add event listener to the visited cities block
        document.querySelectorAll(".venue_image_container_city").forEach(function (block) {
          return block.addEventListener("click", function () {
            // get the clicked city name
            var city = this.dataset.city;
            var category = this.dataset.category; // set the city inputs value

            _globalSelect.locationInput.forEach(function (inputy) {
              return inputy.value = city;
            }); // set the category value
            // 0. active the category block on the hero section


            document.querySelector("div[data-filtername=\"".concat(category, "\"]")).classList.add("activeFilter"); // sethe the input value on the fixed search form

            _globalSelect.categoryInput.value = category; // call the function that fetch venues

            (0, _index.fetchCities)(); // scroll to the top
...
var _default = GetCities;
exports.default = _default;
var handleUI = new GetCities();
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","@glidejs/glide":"node_modules/@glidejs/glide/dist/glide.esm.js","../components/storage":"components/storage.js","../components/classRemover":"components/classRemover.js","../components/validator":"components/validator.js","../components/getCities":"components/getCities.js","../js/index":"js/index.js","../components/globalSelect":"components/globalSelect.js"}],"components/map.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(HereMaps, [{
    key: "load",
    value: function load(mapContainer, placesLocation) {
      //clear the map container
      mapContainer.innerHTML = ""; // intialize the HERE Maps Apis
      ...
      var defaultMapLayers = platform.createDefaultLayers(); // 1. get the map from the map object and diplay it

      var map = new H.Map(mapContainer, defaultMapLayers.normal.traffic); // Enable the event on the map instance

      var mapEvents = new H.mapevents.MapEvents(map); // Enable the default map behavior (zoom, ...)

      new H.mapevents.Behavior(mapEvents); // add the default controler on the map

      H.ui.UI.createDefault(map, defaultMapLayers); // initialize the icon

      var imgIcon = "logo.91a27c4f_new.png"; //display all venues on the map

      placesLocation.map(function (latLng) {
        // Creat an icon, an object holding the latitude and longitude, adn a marker
        var icon = new H.map.Icon(imgIcon),
            coords = {
          lat: latLng.lat,
          lng: latLng.lng
        },
...
var _default = HereMaps;
exports.default = _default;
},{}],"components/switch.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.handleSwitch = exports.default = void 0;
...
var _getVisitedCities = _interopRequireDefault(require("../components/getVisitedCities"));
...
var handleSave = new _storage.default();
var handleGetElementLocation = new _getElementLocation.default();
var handleClassRemove = new _classRemover.default();
var handleValidator = new _validator.default();
var handleGetFavoriteVenues = _getFavorite.handleDisplayVenue;
var handleVisitedCities = new _getVisitedCities.default();
var handleMap = new _map.default();
...
function () {
  ...
  _createClass(Switch, [{
    key: "handleSwitchToggleMap",
    value: function handleSwitchToggleMap() {
      // update the map container
      var venuesLatLng = handleSave.handleRetriveData("venuesLatLng") || []; // check to see if you have any latitude and longitude

      if (venuesLatLng && venuesLatLng.length > 0) {
        // clear the map container
        _globalSelect.$map.innerHTML = ""; // wait 1s

        setTimeout(function () {
          // display the venues on the map
          handleMap.load(_globalSelect.$map, venuesLatLng);
        }, 1000);
      }

      var searchContainer = document.querySelector(".search_result_wrapper");
      var searchResultBlock = document.querySelector(".search_result_block_container");
      var searchResultCotent = document.querySelector(".search_result_block_content");
      ...
      if (!switchButton.classList.contains("active")) {
        ...
        searchResultBlock.classList.remove("search_result_block_container_map_visible");
        searchResultCotent.classList.remove("search_result_block_content_map_visible"); // make the wrapper container more large

        searchContainer.classList.add("search_result_wrapper_map_not_visible");
        searchResultBlock.classList.add("search_result_block_container_map_not_visible");
        searchResultCotent.classList.add("search_result_block_content_map_not_visible");
      } else {
        // add the map to the right side and put it at he bottom
        searchContainer.classList.add("search_result_wrapper_map_visible");
        searchResultBlock.classList.add("search_result_block_container_map_visible");
        searchResultCotent.classList.add("search_result_block_content_map_visible"); // make the wrapper container leff large to display the map to the right side

        searchContainer.classList.remove("search_result_wrapper_map_not_visible");
        searchResultBlock.classList.remove("search_result_block_container_map_not_visible");
        searchResultCotent.classList.remove("search_result_block_content_map_not_visible");
      } // remove or add the active state to all swith button


      _globalSelect.switchButtonAll.forEach(function (button) {
        return button.classList.toggle("active");
      });
    }
  }, {
    key: "handleSwitchCategory",
    value: function handleSwitchCategory() {
      var categoryFilter = document.querySelectorAll(".form_filter");
      var clickedCategoryId = this.dataset.filtername;
      categoryFilter.forEach(function (filter) {
        var classes = filter.classList;
        filter.dataset.filtername === clickedCategoryId ? classes.add("activeFilter") : classes.remove("activeFilter");
      }); // set the header background to reflect the cliked category

      _globalSelect.headerHero.setAttribute("id", "".concat(clickedCategoryId, "_bg")); // set the value of the category input to the clicked category name


      _globalSelect.categoryInput.value = handleValidator.capitalize(clickedCategoryId);
    }
  }, {
    key: "showDropDown",
    value: function showDropDown() {
      var inputId = this.getAttribute("name");
      var inputWidth = handleGetElementLocation.getElementLocation(this).width;

      _globalSelect.dropdown.forEach(function (drop) {
        if (drop.classList.contains(inputId)) {
          drop.style.width = inputWidth + "px";
          drop.style.display = "block"; // turn the chevron up and down

          _globalSelect.inputs.forEach(function (input) {
    ...
    key: "handleSwitchFixSearchForm",
    value: function handleSwitchFixSearchForm() {
      ...
      var elementOffsetTop = _globalSelect.searchResultTitle.offsetTop + 20; // get the positon of element so that we can deside when to load the favorite places and visited cities

      var placesYouLikeLocation = _globalSelect.placesYouLike.getBoundingClientRect();

      var visitedCitiesTitleLocation = _globalSelect.visitedCitiesTitile.getBoundingClientRect(); // get the percentage at which the favorite places title is.


      var placesYouLikePercentScrolledInViewport = handleValidator.isAtACertainPercentOfTheViewport(placesYouLikeLocation.bottom); // get the percentage at which the visited title is.

      var visitedCitiesPercentScrolledInViewport = handleValidator.isAtACertainPercentOfTheViewport(visitedCitiesTitleLocation.bottom);

      if (placesYouLikePercentScrolledInViewport < 67) {
        // hide the search result details in the fix search form
        _globalSelect.currentFilterDetailsFixedForm.style.display = "none"; // get favorite venues from the local storage and display them

        handleGetFavoriteVenues.handleFavorite("all");
      } else {
        // show the search result details in the fix search form
        _globalSelect.currentFilterDetailsFixedForm.style.display = "block";
      }
      ...
      if (elementOffsetTop > window.scrollY && _globalSelect.fixForm.classList.contains("hide_fix_search_form")) return;

      if (elementOffsetTop < window.scrollY && _globalSelect.fixForm.classList.contains("show_fix_search_form")) {
        return;
      }

      if (elementOffsetTop > window.scrollY) {
        handleClassRemove.handleRemoveClass(_globalSelect.fixForm, "show_fix_search_form");
        handleClassRemove.handleAddClass(_globalSelect.fixForm, "hide_fix_search_form");
      } else {
        handleClassRemove.handleRemoveClass(_globalSelect.fixForm, "hide_fix_search_form");
        handleClassRemove.handleAddClass(_globalSelect.fixForm, "show_fix_search_form");
      } // hide all dropdown
...
var _default = Switch;
exports.default = _default;
var handleSwitch = new Switch();
exports.handleSwitch = handleSwitch;
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","./storage":"components/storage.js","./getElementLocation":"components/getElementLocation.js","../components/classRemover":"components/classRemover.js","../components/validator":"components/validator.js","../components/getFavorite":"components/getFavorite.js","../components/getVisitedCities":"components/getVisitedCities.js","../components/map":"components/map.js","./globalSelect":"components/globalSelect.js"}],"components/closeFormDropdown.js":[function(require,module,exports) {
"use strict";
"use strcit";
...
function () {
  function HandleCloseDrop() {
    _classCallCheck(this, HandleCloseDrop);
  }

  _createClass(HandleCloseDrop, [{
    key: "closeDropdown",
    value: function closeDropdown(e) {
      // e.preventDefault();
      e.stopPropagation();
      var targetElement = e.target.classList;

      if (targetElement.contains("search_form_home") || targetElement.contains("search_form_home_filters") || targetElement.contains("search_result_main_title") || targetElement.contains("main") || targetElement.contains("submit_button") || targetElement.contains("seach_result_details") || targetElement.contains("fix_search_form") || targetElement.contains("general_wrapper")) {
        _globalSelect.inputs.forEach(function (input) {
          input.classList.remove("arrow_up");
          input.classList.add("arrow_down");
        });

        _globalSelect.dropdownContainer.forEach(function (dropdown) {
  ...
  return HandleCloseDrop;
}();

var _default = HandleCloseDrop;
exports.default = _default;
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","../components/globalSelect":"components/globalSelect.js"}],"components/displayVenues.js":[function(require,module,exports) {
"use strict";
...
/// instantiate the object
var handleInnerHTMLChange = new _classRemover.default();
var handleStore = new _storage.default();
var validate = new _validator.default();
var handleVenuesLike = new _handleVenuesLike.default();
var handleMap = new _map.default();
...
function () {
  function DisplayVenues() {
    _classCallCheck(this, DisplayVenues);
  }

  _createClass(DisplayVenues, [{
    key: "venuesUI",
    value: function venuesUI(data) {
      // set the array to old venue idsd
      var venueIds = []; // set the array to old venue latitude and longetude
      // for the later use to display them on the map.

      var venuesLatLng = []; // set the venues list array

      var venuesList = data; //console.log(venuesList);
      // get the user search detail from the local storage

      var userInfoDetail = handleStore.handleRetriveData(_globalSelect.userFilterOptionKeyname); // save current venues in local storage

      handleStore.handleSaveData("currentVenues", JSON.stringify(venuesList)); // distructure the search result object

      var category = userInfoDetail.category,
          city = userInfoDetail.city,
          resultCount = userInfoDetail.resultCount; // displaly the result details to the user

      handleInnerHTMLChange.setInnerHtml(_globalSelect.searchResultCounter, "".concat(resultCount, " ").concat(validate.isPlural(resultCount, "Result")));
      handleInnerHTMLChange.setInnerHtml(_globalSelect.searchResultCategory, validate.capitalize(category));
      handleInnerHTMLChange.setInnerHtml(_globalSelect.searchResultLocation, city);

      _globalSelect.categoryDetailsIcon.forEach(function (icon) {
        return icon.setAttribute("src", "https://ephraimilunga.co.za/eweather/icons/".concat(category, "_red.svg"));
      }); // display the venues to the user


      var venues = venuesList.map(function (venue) {
        ...
        return "\n            <div id=\"".concat(venue.id, "\" data-category=\"").concat(category, "\" class=\"venue_block_container\">\n                <div class=\"venue_image_container\" style=\"background-image: url('https://source.unsplash.com/featured/?").concat(category, "')\">\n                    <div class=\"venue_set_favorite_container\">\n                        <img data-status=\"").concat(validate.isInFavoriteList(venue.id) ? "liked" : "", "\" class=\"favorite_icon\" src=\"").concat(validate.isInFavoriteList(venue.id) || "favorite_home.eef3b794.svg", "\" alt=\"\">\n                    </div>\n                </div>\n            \n                <div class=\"venue_description_name_address\">\n                    <p class=\"venue_description\">").concat(validate.isFalsy(venue.categories[0], "category"), "</p>\n                    <p class=\"venue_name\">").concat(validate.isFalsy(venue.name), "</p>\n                    <p class=\"venue_address\">").concat(validate.isFalsy(venue.location.formattedAddress[0]), " </p>\n                    <p class=\"venue_sub_address\">").concat(validate.isFalsy(venue.location.formattedAddress[1]), "</p>\n                </div>\n            \n                <div class=\"venue_distance_explore_button\">\n                    <div class=\"venue_distance\">\n                        <img src=\"distance_search.982581db.svg\" alt=\"eplaces\">\n                        <p>").concat(validate.isFalsy(validate.roundToPrecision(validate.mathOperations(venue.location.distance, 1000, "div"), 1)), "km</p>\n                    </div>\n                    <div class=\"venue_explore_button\">\n                        <button data-from=\"home\" class=\"explore_button\" id=\"").concat(validate.isFalsy(venue.id), "\">Explore</button>\n                    </div>\n                </div>\n            </div>\n      ");
      }).join(""); // save the current city as visited

      var visitedCities = handleStore.handleRetriveData(_globalSelect.visitedCitiesKeyname); //set the new venue info

      var visitedCitiesListInfo = {
        city: city,
        category: category
      ...
      if (!visitedCities) {
        var visitedCitiesList = [];
        visitedCitiesList.push(visitedCitiesListInfo);
        handleStore.handleSaveData(_globalSelect.visitedCitiesKeyname, JSON.stringify(visitedCitiesList));
      } else {
        // set a flag to determine whether the current city has been visited by the current user
        var newVisit = true; // map through all visited cities from the local storage
        // if a city match match the current city and filter category
        // set the flag to false. This prevent multiple saving.

        visitedCities.map(function (visitedCity) {
          if (visitedCity.city === city && visitedCity.category === category) newVisit = false;
        ...
        if (newVisit) {
          ...
          handleStore.handleSaveData(_globalSelect.visitedCitiesKeyname, JSON.stringify(visitedCities));
        }
      } // display the venues to the UI.


      handleInnerHTMLChange.setInnerHtml(_globalSelect.resultContainer, venues);
      setTimeout(function () {
        var favoriteIcon = document.querySelectorAll(".favorite_icon"); /// listen for a click event on all favorite icons to set a venue liked or unliked

        favoriteIcon.forEach(function (icon) {
          return icon.addEventListener("click", handleVenuesLike.handleLikes);
        });
        document.querySelectorAll(".explore_button").forEach(function (button) {
          button.addEventListener("click", validate.handllRedirection);
        });
      }, 2000); // save the venues latitude and longitude

      handleStore.handleSaveData("venuesLatLng", JSON.stringify(venuesLatLng)); // send the venues latitude and longitude to map method that will display venues on map.
...
var _default = DisplayVenues;
exports.default = _default;
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","../components/classRemover":"components/classRemover.js","../components/storage":"components/storage.js","../components/validator":"components/validator.js","../components/handleVenuesLike":"components/handleVenuesLike.js","../components/map":"components/map.js","../components/globalSelect":"components/globalSelect.js"}],"components/singleviewUI.js":[function(require,module,exports) {
"use strict";
...
///*********** INSTANTIATE OBJEST ******** */
var handleClassRemove = new _classRemover.default();
var handleMap = new _map.default(); // *********** CLASS DECALRATION *********** //

var SingleViewUI =
/*#__PURE__*/
function () {
  function SingleViewUI() {
    _classCallCheck(this, SingleViewUI);
  }

  _createClass(SingleViewUI, [{
    key: "handleHideShowComment",
    //**

    /* Show and hide the testimonials slider
     */
    value: function handleHideShowComment() {
      // remove or hide the testimonials container
      if (handleClassRemove.handleHasThisClass(_globalSelect.testimonyContainer, _globalSelect.hideTestimonialContaienr)) {
        handleClassRemove.handleRemoveClass(_globalSelect.testimonyContainer, _globalSelect.hideTestimonialContaienr);
      } else {
        handleClassRemove.handleAddClass(_globalSelect.testimonyContainer, _globalSelect.hideTestimonialContaienr);
      }
    } // */

  }, {
    key: "handleDisplayVenueDetails",
    value: function handleDisplayVenueDetails() {
      // BUILD THE VENUE DETAILS SECTION
      var v = JSON.parse(localStorage.getItem("v")); //localStorage.setItem("v", JSON.stringify(v));

      var venueDetailsHtml = "\n\n    <div class=\"single_details_one\">\n        <a href=\"".concat(isTruthy(v.url), "\"><img src=\"global.529c85ba.svg\" alt=\"").concat(isTruthy(v.url), "\"\"></a>\n        <a href=\"tel:").concat(isTruthy(parseObj(v.contact, "phone")), "\"><img src=\"phone.00c8e429.svg\" alt=\"\"></a>\n\n        <div class=\"single_meters\">\n            <p>").concat(isTruthy(parseObj(v.price, "currency")), "</p>\n        </div>\n\n        <div class=\"single_likes\">\n            <img src=\"icons/full_red_heart.svg\" alt=\"\">\n            <p>").concat(isTruthy(v.ratingSignals), "</p>\n        </div>\n\n        <div class=\"single_verify\">\n            ").concat(isVerify(v.verified), "\n        </div>\n\n        <div styly=\"background-color:#").concat(v.ratingColor, ";\" class=\"single_rating\">\n            <p>").concat(isTruthy(v.rating), "</p>\n        </div>\n    </div>\n\n    <div class=\"single_name_category_address\">\n        <p class=\"single_name\">").concat(isTruthy(v.name), "</p>\n        <p class=\"single_category\">Category : ").concat(isTruthy(parseObj(v.categories, "name")), "</p>\n        <p class=\"single_address\">").concat(parseObj(v.location, "address"), "</p>\n        <p class=\"single_city\">").concat(isTruthy(parseObj(v.location, "city")), ", ").concat(isTruthy(parseObj(v.location, "state")), "</p>\n        <p class=\"single_country\">").concat(isTruthy(parseObj(v.location, "country")), "</p>\n\n    </div>\n\n    <div class=\"single_more_category\">\n        ").concat(displayCat(v.categories), "\n        <div class=\"cat_ single_checkedin\">").concat(parseObj(v.stats, "checkinsCount") ? parseObj(v.stats, "checkinsCount") : 0, " Checked in</div>\n    </div>\n\n    <div class=\"single_venue_open_hours\">\n        <div class=\"parent single_open_unil\">\n            <img src=\"icons/clock_red.svg\" alt=\"\">\n            <div class=\"child open_until\">\n                <p class=\"open_until_text\">Open until</p>\n                <p class=\"open_until_time\">1:00 AM</p>\n            </div>\n        </div>\n\n        <div class=\"parent single_weekdays_frame\">\n            <img src=\"icons/calendar.svg\" alt=\"\">\n            <div class=\"child open_until\">\n                <p class=\"open_until_text\">Mon - Sun</p>\n                <p class=\"open_until_time\">Now Open</p>\n            </div>\n        </div>\n\n        <div class=\"parent single_weekdays_frame\">\n            <img src=\"icons/calendar_clock.svg\" alt=\"\">\n            <div class=\"child open_until\">\n                <p class=\"open_until_text\">Mon \u2013 Sun</p>\n                <p class=\"open_until_time\">6:00 AM\u20131:00 AM</p>\n            </div>\n        </div>\n    </div>\n\n    <div class=\"single_activity_hours\">\n        <p class=\"single_activity_hours_title\">Map</p>\n\n        <div width=\"100\" id=\"singlemap\">\n        </div>\n\n    </div>\n\n    \n    "); // display the venue detaills to the user

      _globalSelect.singleVenueDetailsContainer.innerHTML = venueDetailsHtml; // display the venue on the map

      if (isTruthy(v.location.lat) && isTruthy(v.location.lng)) {
        var lat = v.location.lat;
        var lng = v.location.lng; // set the venue location
...
var _default = SingleViewUI; // validator
  ...
  if (catList) {
    if (catLength > 1) {
      return catList.map(function (cat) {
        return "<div class=\"cat_\">".concat(cat.name, "</div>");
      });
    }

    if (catLength === 1) {
      return "<div class=\"cat_\">".concat(catList[0].name, "</div>");
    }
...
},{"../components/classRemover":"components/classRemover.js","../components/map":"components/map.js","../components/globalSelect":"components/globalSelect.js"}],"components/apisRequest.js":[function(require,module,exports) {
"use strict";
...
var _displayVenues = _interopRequireDefault(require("../components/displayVenues"));

var _singleviewUI = _interopRequireDefault(require("../components/singleviewUI"));
...
var validate = new _validator.default();
var handleRemove = new _classRemover.default();
var handleDisplayVenues = new _displayVenues.default();
var handleSingleVenueUI = new _singleviewUI.default();

var HandleFechApis =
/*#__PURE__*/
function () {
  function HandleFechApis(category, city, limit, venuesId) {
    _classCallCheck(this, HandleFechApis);
  ...
  _createClass(HandleFechApis, [{
    key: "getUsertCurrentLocation",
    value: function () {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                return fetch("".concat(corsApiUrl).concat(ipToLocation).concat(ip)).then(function (result) {
                  ...
                  currentLocation = JSON.stringify(currentLocation); // store the current user location in the local storage

                  handleStore.handleSaveData("currentLocationEplaces", currentLocation); // set the value of the location input to the current user city

                  _globalSelect.locationInput.forEach(function (input) {
                    return input.value = userCurrentCity;
                  });
                }).catch(function (e) {
                  return console.log(e.message);
                });
      ...
      function getUsertCurrentLocation() {
        return _getUsertCurrentLocation.apply(this, arguments);
      }

      return getUsertCurrentLocation;
    }()
  }, {
    key: "handleGetVenue",
    value: function () {
      var _handleGetVenue = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2() {
        var category, cityValue, limit, city, apiBaseURL, foursquareKeyApi, venuesBaseURL, cityCoordinate;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                cityValue = this.city;
                limit = this.limit; // check to see if the city is type of object or a string

                city = _typeof(cityValue) === "object" ? cityValue.city : cityValue; // get the user lat and long api link

                apiBaseURL = "http://gd.geobytes.com/GetCityDetails?fqcn=".concat(city); // foursquare api (get the venues api);

                foursquareKeyApi = "client_id=AOBANJKB3CNBFTYOITBPVH3U2MPLLBSVM04Y34OHVSE0DWUB&client_secret=QO1H1W0XPHNDCKEVNJ0ULMZ4CS3UN2OOAR4KOXSFWHJGWRQ5&";
                venuesBaseURL = "https://api.foursquare.com/v2/venues/search?"; // fetch city / location coordoninate
              ...
              case 9:
                cityCoordinate = _context2.sent;
                _context2.next = 12;
                return fetch("".concat(venuesBaseURL).concat(foursquareKeyApi, "ll=").concat(validate.isLatLongEmpty(cityCoordinate.geobyteslatitude, "lat"), ",").concat(validate.isLatLongEmpty(cityCoordinate.geobyteslongitude, "long"), "&query=").concat(category, "&radius=").concat(limit, "&intent=checkin&v=").concat(_globalSelect.versionningDate)).then(function (result) {
                  return result.json();
                }).then(function (data) {
                  // remove the disable state to the submit button
                  handleRemove.handleRemoveClass(_globalSelect.submitButtons, _globalSelect.disableHtmlElement); // change the innerHTML or text content in the submit button

                  handleRemove.setInnerHtml(_globalSelect.submitButtons, "Search"); // check if the query returns 1 or more venues

                  if (data.response.venues.length > 0) {
                    //display loader to the user
                    handleRemove.setInnerHtml(_globalSelect.searchResultCounter, _globalSelect.loaderSearchResultDetailsBlock);
                    handleRemove.setInnerHtml(_globalSelect.searchResultCategory, _globalSelect.loaderSearchResultDetailsBlock);
                    handleRemove.setInnerHtml(_globalSelect.searchResultLocation, _globalSelect.loaderSearchResultDetailsBlock); // display the venues

                    var venuesList = data.response.venues;
                    setTimeout(function () {
                      handleDisplayVenues.venuesUI(venuesList);
                    }, 2000); // create a object base on the user filter values
                    ...
                    var userFilterData = JSON.stringify(userFilterOptions); //save the user filter values in the local storage

                    handleStore.handleSaveData(_globalSelect.userFilterOptionKeyname, userFilterData);
                  } else {
                    _globalSelect.mainMessageToTheUser.innerHTML = "\n            <div class=\"message_to_user_container\">\n            <div class=\"message_title_text\">\n                <p class=\"main_message_title\">Sorry ! Nothing was found for <span class=\"highlight\">".concat(validate.capitalize(category), "</span> in <span\n                        class=\"highlight\">").concat(city, "</span> within <span class=\"highlight\">").concat(validate.roundToPrecision(validate.mathOperations(limit, 100, "div"), 1), "</span>km</p>\n                <p class=\"sub_message_title\">This means no venue in ").concat(city, " within ").concat(validate.roundToPrecision(validate.mathOperations(limit, 100, "div"), 1), "km has a profile</p>\n                <p class=\"message_suggestion\">Please, try to increase the bounds limit or refine your search</p>\n            </div>\n    \n            <div class=\"message_action_button\">\n                <a href=\"#back_to_search\" class=\"refine_message\">Refine</a>\n            </div>\n        </div>\n          ");
                    handleRemove.handleRemoveClass(_globalSelect.mainMessageToTheUser, _globalSelect.alertMessageClass);
                  }
                });
      ...
      function handleGetVenue() {
        return _handleGetVenue.apply(this, arguments);
      }

      return handleGetVenue;
    }()
  }, {
    key: "handleFetchVenueDetails",
    value: function () {
      var _handleFetchVenueDetails = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee3(venueId) {
        var endPoint, apiKeysAndVersion;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                endPoint = "https://api.foursquare.com/v2/venues/"; // api keys

                apiKeysAndVersion = "?client_id=AOBANJKB3CNBFTYOITBPVH3U2MPLLBSVM04Y34OHVSE0DWUB&client_secret=QO1H1W0XPHNDCKEVNJ0ULMZ4CS3UN2OOAR4KOXSFWHJGWRQ5&v=20190201"; // fetch venue details

                console.log(venueId, "".concat(endPoint).concat(venueId).concat(apiKeysAndVersion));
                _context3.next = 5;
                return fetch("".concat(endPoint).concat(venueId).concat(apiKeysAndVersion)).then(function (result) {
                  return result.json();
                }).then(function (data) {
      ...
      function handleFetchVenueDetails(_x) {
        return _handleFetchVenueDetails.apply(this, arguments);
      }

      return handleFetchVenueDetails;
    }()
  }]);

  return HandleFechApis;
}();

var _default = HandleFechApis;
exports.default = _default;
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","../components/storage":"components/storage.js","../components/globalSelect":"components/globalSelect.js","../components/validator":"components/validator.js","../components/classRemover":"components/classRemover.js","../components/displayVenues":"components/displayVenues.js","../components/singleviewUI":"components/singleviewUI.js"}],"js/index.js":[function(require,module,exports) {
...
var _closeFormDropdown = _interopRequireDefault(require("../components/closeFormDropdown"));
...
// INSTANTIATE OBJECTS
var swich = new _switch.default();
var fechCities = new _getCities.getCities();
var handleUI = new _getCities.UI();
var hanleCloseDropdown = new _closeFormDropdown.default();
var handleStoreData = new _storage.default();
var apisRequestObject = new _apisRequest.default();
var handleRemove = new _classRemover.default();
var handleVenuesLike = new _handleVenuesLike.default();
var handleValidate = new _validator.default();
var handleGetFavorite = _getFavorite.handleDisplayVenue;
var handleGetVisitedCities = new _getVisitedCities.default(); // END INSTANTIATE OBJECTS
//******* */ switch the map *********//
// get the switch element

_globalSelect.switchButtonAll.forEach(function (button) {
  return button.addEventListener("click", swich.handleSwitchToggleMap);
}); // ****** switch the category on the home search form


_globalSelect.categoryFilter.forEach(function (filter) {
  return filter.addEventListener("click", swich.handleSwitchCategory);
}); // ******* display the input's dropdown


_globalSelect.inputs.forEach(function (input) {
  return input.addEventListener("focus", swich.showDropDown);
}); //******* */ fillup the city when the user type in


_globalSelect.locationInput.forEach(function (input) {
  return input.addEventListener("input", fechCities.fetchCities);
}); //*** */ get the cliked city value and fill the target input with that value


_globalSelect.dropdownContainer.forEach(function (drop) {
  return drop.addEventListener("click", handleUI.fillupTheForom);
}); //******* */ get the event on the limit field


_globalSelect.limitInput.forEach(function (input) {
  return input.addEventListener("focus", handleUI.handleLimitInput);
});

_globalSelect.limitInput.forEach(function (input) {
  return input.addEventListener("input", handleUI.handleLimitInput);
}); // ****** close all drop down when a user click on the main coainter


_globalSelect.mainContainer.addEventListener("click", hanleCloseDropdown.closeDropdown); // this function call the method in charge of fetching venues via APIs


function fetchCities() {
  // set the loaded status to true to avoid multiple loading
  handleStoreData.handleSaveData(_globalSelect.loadedVenuesStatus, JSON.stringify({
    status: true
  })); // display the loader to the user

  handleRemove.setInnerHtml(_globalSelect.resultContainer, _globalSelect.blockResultsLoader); // add a loader to the button

  _globalSelect.submitButtons.forEach(function (button) {
    return button.innerHTML = _globalSelect.searchButonLoader;
  }); //desable the button to avoid multiple submitions


  _globalSelect.submitButtons.forEach(function (button) {
    return button.classList.add("disableElement");
  }); //get the user info from the input field


  var category = document.querySelector(".activeFilter");
  var city = document.querySelector("input#location");
  var limit = document.querySelector("input#limit");
  var limitHeaderHero = document.querySelector(".limit_on_header_hero"); //*********** set the value for each option
  // get the category value from the dataset

  var categoryDatasetValue = category ? category.dataset.filtername : "food"; //set category name value

  var categoryValue = categoryDatasetValue; // set city name value

  var cityValue = city.value !== null ? city.value : handleStoreData.handleRetriveData("currentLocation").city; // extract integer from the limit input value
  // and convert it in meters.

  var limitValueExtracted = handleValidate.extractFirstNumber(limit.value) * 1000 || handleValidate.extractFirstNumber(limitHeaderHero.value) * 1000; //if the limit equal to 0 then set the it to 100km as default limit.

  var limitValue = limitValueExtracted > 0 ? limitValueExtracted : 100000; // set the value to the handle get venues object

  var sentDataToTheHandler = new _apisRequest.default(categoryValue, cityValue, limitValue);
...
function isTheUserScrollWithoutSearching() {
  ...
  var loadedStatus = handleStoreData.handleRetriveData(_globalSelect.loadedVenuesStatus); // stop the function from runnig if we have already loaded venues

  if (loadedStatus && loadedStatus.status) return; // get main search result contaienr poisition

  var mainResultContainerPosition = _globalSelect.resultMainContainer.getBoundingClientRect().bottom; // display currrent location venue if the user start scrolling


  var resultContainerScroll = handleValidate.isAtACertainPercentOfTheViewport(mainResultContainerPosition);

  if (resultContainerScroll < 190) {
    fetchCities(); // set the loaded status to true to avoid multiple loading
...
_globalSelect.mainMessageToTheUser.addEventListener("click", function (e) {
  ...
  handleRemove.handleAddClass(_globalSelect.mainMessageToTheUser, _globalSelect.alertMessageClass); // rove the loader

  handleRemove.setInnerHtml(_globalSelect.resultContainer, "<p style='font-size: 40px' class='highlight'>Please, Try again ...</p>");
});

document.addEventListener("DOMContentLoaded", function (e) {
  // images to set as background for the header hero section
  var heroImages = ["hero_first", "hero_second", "hero_third", "hero_fourth", "hero_six", "hero_seven", "hero_fifth"]; // get a random number to match an image from the images object

  var randomNumber = Math.floor(Math.random() * heroImages.length); // set the given image as background

  _globalSelect.headerHero.setAttribute("id", heroImages[randomNumber]); // check to see if you have favorite venues in the localstorage


  var isFavoriteVanuesInLocalStorage = handleStoreData.handleRetriveData("storedFavoriteVenuesId");

  if (isFavoriteVanuesInLocalStorage) {
    // count the favorite venues
    var totalFavorite = handleVenuesLike.handleCountLikes("storedFavoriteVenuesId"); // check if the favorite venues are more than 9
    // if they are more than 9 display 9+ otherwise display the extact number (eg: 9, 3, 2, 1, 0);

    var isTotalFavGreatThanNine = handleValidate.isFavoriteGreatThanNine(totalFavorite); //set the text of the favorite counter to the total liked venues

    handleRemove.setInnerHtml(_globalSelect.favoriteCounters, isTotalFavGreatThanNine); // delete the loaded status

    handleStoreData.handleDeleteData(_globalSelect.loadedVenuesStatus);
  ...
  handleStoreData.handleDeleteData("loadFavoriteStatus"); // delete the load visited cities status
...
window.addEventListener("scroll", isTheUserScrollWithoutSearching); // // /// listen for a click event on all favorite icons to set a venue liked or unliked
...
_globalSelect.favoriteFilter.forEach(function (filter) {
  return filter.addEventListener("click", function () {
    handleRemove.handleActiveElement(_globalSelect.favoriteFilter, "filter_Active", this.classList[0]);
...
_globalSelect.visitedCitiesFilters.forEach(function (filter) {
  return filter.addEventListener("click", function () {
    handleRemove.handleActiveElement(_globalSelect.visitedCitiesFilters, "filter_Active", this.classList[0]);
    handleGetVisitedCities.handleVisitedCities(this.dataset.favoritecategory, "form");
  });
});
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","../components/switch":"components/switch.js","../components/getCities":"components/getCities.js","../components/closeFormDropdown":"components/closeFormDropdown.js","../components/apisRequest":"components/apisRequest.js","../components/storage":"components/storage.js","../components/classRemover":"components/classRemover.js","../components/handleVenuesLike":"components/handleVenuesLike.js","../components/validator":"components/validator.js","../components/getFavorite":"components/getFavorite.js","../components/getVisitedCities":"components/getVisitedCities.js","../components/globalSelect":"components/globalSelect.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
